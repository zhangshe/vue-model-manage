<template>
  <div>
    <div class="navbar">
      ...
      <h2 style="color:#fff;float:left;line-height: 45px;margin-left: 5%;">模型详情</h2>
...
<!--            </el-col>-->
          ...
          <el-row v-else>
            <el-button style="width:200px;margin-bottom:1%;margin-top:1%;" type="primary" @click="ApiClick()">模型试用</el-button>
