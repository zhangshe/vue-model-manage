    ...
    <div class="main-container-new">
        ...
        >上传模型
                ...
                <div class="condition">
                    <div class="condition_item">
                        ...
                        <div class="condition_item_list">
                            ...
                            <span v-for="item in topicList" :key="item.name" v-bind:class="classObject(item.name)" @click="selectTopic(item)">{{item.name}}</span>
                        </div>
                    </div>
                    <div class="condition_item">
                        ...
                        <div class="condition_item_list">
                            ...
                            <span v-for="item in keshiList" :key="item.name" v-bind:class="classObject1(item.name)" @click="selectKeshi(item)">{{item.name}}</span>
                        </div>
                    </div>
                    <div class="condition_item">
                        ...
                        <div class="condition_item_list">
                            ...
                            <span v-for="item in sceneList" :key="item.dicItemName" v-bind:class="classObject2(item.dicItemName)" @click="selectScene(item)">{{item.dicItemName}}</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="calalogList">
                ...
                <div class="calalogList_item" v-for="(item, index) in dataList" :key="index" @click="goDetail(item.id)">
                    <div class="item_top">
